          ...
          <AccordionItemPanel className="packPanel">
            <p>
              <ul>
                ...
                <li>
                  Bathroom, Terrace & Utility Door – Frame & shutter including
                  hardware – Rs.7,500/- per door
                </li>
                <li>Door hardware – Ozone/Europa/Dorma make</li>
                <li>Door hinges – SS hinges</li>
                <li>
                  Door & Door Frame cost – Inclusive of planing, rebate,
                  transportation etc.
                </li>
              </ul>
            </p>
