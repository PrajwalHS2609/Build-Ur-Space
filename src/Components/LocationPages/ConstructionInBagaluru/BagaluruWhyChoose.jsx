...
const BagaluruWhyChoose = () => {
  return (
    <div className="locationHeadContainer">
      <h2>
        <span>Why Choose</span> Our House Construction Company in Bagaluru?{" "}
      </h2>
      ...
      <li>
        ...
        <p>
          ...
          villa, our House Construction Company in Bagaluru can bring your
          vision to reality.
        </p>
      </li>
      <li>
...
export default BagaluruWhyChoose;
