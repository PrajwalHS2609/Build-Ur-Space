...
const BagaluruBudget = () => {
  return (
    <div className="locationHeadContainer">
      ...
      <p>
        Our House Construction Company in Bagaluru caters to a wide range of
        budgets without compromising on quality. Whether you’re building a
